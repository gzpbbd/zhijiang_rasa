...
class ActionInstitutionAttributeFoundationTime(Action):
    def __init__(self):
        self.dic = inquiry_key_value("actions/qa_database/机构（属性信息）.csv", "机构名|别称", "奠基时间")

    def name(self) -> Text:
        return "action_institution_attribute_foundation__time"
