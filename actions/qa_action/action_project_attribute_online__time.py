...
class ActionProjectAttributeOnlineTime(Action):
    def __init__(self):
        self.dic = inquiry_key_value("actions/qa_database/项目.csv", "名称", "上线时间")

    def name(self) -> Text:
        return "action_project_attribute_online__time"
