...
class ActionInstitutionAttributeIntroduction(Action):
    def __init__(self):
        self.dic = inquiry_key_value("actions/qa_database/机构（属性信息）.csv", "机构名|别称", "简介")

    def name(self) -> Text:
        return "action_institution_attribute_introduction"
