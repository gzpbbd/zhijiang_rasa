...
class ActionInstitutionAttributeConstructionGoal(Action):
    def __init__(self):
        self.dic = inquiry_key_value("actions/qa_database/机构（属性信息）.csv", "机构名|别称", "建设目标")

    def name(self) -> Text:
        return "action_institution_attribute_construction__goal"
