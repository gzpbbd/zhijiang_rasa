...
class ActionInstitutionAttributeRepresentativeSong(Action):
    def __init__(self):
        self.dic = inquiry_key_value("actions/qa_database/机构（属性信息）.csv", "机构名|别称", "代表歌曲")

    def name(self) -> Text:
        return "action_institution_attribute_representative__song"
